...
##### 		[4.1 `document` 元素](https://html.spec.whatwg.org/multipage/semantics.html#the-root-element)
...
​				[4.5.19 `sub` 元素和 `sup` 元素](https://html.spec.whatwg.org/multipage/text-level-semantics.html#the-sub-and-sup-elements)
...
​						[4.6.7.4  `"canonical"` 型链接](https://html.spec.whatwg.org/multipage/links.html#link-type-canonical)
...
​								[4.8.11.11.3 采购带外文本轨道](https://html.spec.whatwg.org/multipage/media.html#sourcing-out-of-band-text-tracks)
...
​				[4.9.2 `caption·` 元素](https://html.spec.whatwg.org/multipage/tables.html#the-caption-element)
...
​				[4.10.4 `label` 元素](https://html.spec.whatwg.org/multipage/forms.html#the-label-element)
...
​								[4.10.5.1.19 图像按钮状态（`type=image`）](https://html.spec.whatwg.org/multipage/input.html#image-button-state-(type=image))
...
​				[4.10.9 `optgroup` 元素](https://html.spec.whatwg.org/multipage/form-elements.html#the-optgroup-element)
...
​								[4.10.18.7.1 自动填充表单控件：`autocomplete` 属性](https://html.spec.whatwg.org/multipage/form-control-infrastructure.html#autofilling-form-controls:-the-autocomplete-attribute)
...
​						[4.12.3.1 `template` 元素与 `XSLT` 和 `XPath` 的交互](https://html.spec.whatwg.org/multipage/scripting.html#template-XSLT-XPath)
...
​						[4.12.5.2 `ImageBitmap` 渲染上下文](https://html.spec.whatwg.org/multipage/canvas.html#the-imagebitmap-rendering-context)
...
##### 		[5.2 编码微数据](https://html.spec.whatwg.org/multipage/microdata.html#encoding-microdata)
...
​				[6.3.2 `inert` 属性](https://html.spec.whatwg.org/multipage/interaction.html#the-inert-attribute)
...
​				[6.8.1 使文档区域可编辑：`contenteditable` 内容属性](https://html.spec.whatwg.org/multipage/interaction.html#contenteditable)
...
##### 		[6.11 `popover` 属性](https://html.spec.whatwg.org/multipage/popover.html#the-popover-attribute)
...
​						[7.2.1.3 共享抽象操作](https://html.spec.whatwg.org/multipage/nav-history-apis.html#shared-abstract-operations)
...
​				[7.2.4 `Location` 接口](https://html.spec.whatwg.org/multipage/nav-history-apis.html#the-location-interface)

​						[7.2.4.1 [[`GetPrototypeOf`\]] （ ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-getprototypeof)

​						[7.2.4.2 [[`SetPrototypeOf`\]] （ V ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-setprototypeof)

​						[7.2.4.3 [[`IsExtensible`\]] （ ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-isextensible)

​						[7.2.4.4 [[`PreventExtensions`\]] （ ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-preventextensions)

​						[7.2.4.5 [[`GetOwnProperty`\]] （ P ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-getownproperty)

​						[7.2.4.6 [[定义拥有财产\]] （ P， Desc ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-defineownproperty)

​						[7.2.4.7 [[`Get`\]] （ P， `Receiver` ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-get)

​						[7.2.4.8 [[`Set`\]] （ P， V， Receiver ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-set)

​						[7.2.4.9 [[`Delete`\]] （ P ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-delete)

​						[7.2.4.10 [[`OwnPropertyKeys`\]] （ ）](https://html.spec.whatwg.org/multipage/nav-history-apis.html#location-ownpropertykeys)

​				[7.2.5 `History` 接口](https://html.spec.whatwg.org/multipage/nav-history-apis.html#the-history-interface)

​				[7.2.6 `Event`  接口](https://html.spec.whatwg.org/multipage/nav-history-apis.html#nav-traversal-event-interfaces)

​						[7.2.6.1 `PopStateEvent` 接口](https://html.spec.whatwg.org/multipage/nav-history-apis.html#the-popstateevent-interface)

​						[7.2.6.2 `HashChangeEvent` 接口](https://html.spec.whatwg.org/multipage/nav-history-apis.html#the-hashchangeevent-interface)

​						[7.2.6.3 `PageTransitionEvent` 接口](https://html.spec.whatwg.org/multipage/nav-history-apis.html#the-pagetransitionevent-interface)

​						[7.2.6.4 `BeforeUnloadEvent` 接口](https://html.spec.whatwg.org/multipage/nav-history-apis.html#the-beforeunloadevent-interface)

##### 		[7.3 文档序列的基础](https://html.spec.whatwg.org/multipage/document-sequences.html#infrastructure-for-sequences-of-documents)
...
​						[7.3.1.2 顶级 `traversable`](https://html.spec.whatwg.org/multipage/document-sequences.html#top-level-traversables)

​						[7.3.1.3 子 `navigables`](https://html.spec.whatwg.org/multipage/document-sequences.html#child-navigables)

​						[7.3.1.4 杰克图](https://html.spec.whatwg.org/multipage/document-sequences.html#jake-diagrams)

​						[7.3.1.5 相关 `navigable` 的集合](https://html.spec.whatwg.org/multipage/document-sequences.html#related-navigable-collections)

​						[7.3.1.6 `Navigable` 销毁](https://html.spec.whatwg.org/multipage/document-sequences.html#garbage-collection-and-browsing-contexts)

​						[7.3.1.7 `Navigable` 的目标名称](https://html.spec.whatwg.org/multipage/document-sequences.html#navigable-target-names)

​				[7.3.2 浏览上下文](https://html.spec.whatwg.org/multipage/document-sequences.html#windows)
...
​						[7.3.2.3 分组浏览上下文](https://html.spec.whatwg.org/multipage/document-sequences.html#groupings-of-browsing-contexts)

​				[7.3.3 完全活跃的文档](https://html.spec.whatwg.org/multipage/document-sequences.html#fully-active-documents)

##### 		[7.4 导航和会话历史](https://html.spec.whatwg.org/multipage/browsing-the-web.html#navigation-and-session-history)

​				[7.4.1 会话历史记录](https://html.spec.whatwg.org/multipage/browsing-the-web.html#session-history-infrastructure)

​						[7.4.1.1 会话历史条目](https://html.spec.whatwg.org/multipage/browsing-the-web.html#session-history-entries)
...
​						[7.4.1.4 对会话历史记录的低级操作](https://html.spec.whatwg.org/multipage/browsing-the-web.html#low-level-operations-on-session-history)

​				[7.4.2 导航](https://html.spec.whatwg.org/multipage/browsing-the-web.html#navigating-across-documents)
...
​						[7.4.2.3 结束导航](https://html.spec.whatwg.org/multipage/browsing-the-web.html#ending-navigation)

​								[7.4.2.3.1 通常的跨文档导航情况](https://html.spec.whatwg.org/multipage/browsing-the-web.html#the-usual-cross-document-navigation-case)

​								[7.4.2.3.2 `javascript:` `URL` 特例](https://html.spec.whatwg.org/multipage/browsing-the-web.html#the-javascript:-url-special-case)
...
​				[7.4.3 重加载和 `traversing`](https://html.spec.whatwg.org/multipage/browsing-the-web.html#reloading-and-traversing)

​				[7.4.4 非片段同步导航](https://html.spec.whatwg.org/multipage/browsing-the-web.html#navigate-non-frag-sync)

​				[7.4.5 填充会话历史条目](https://html.spec.whatwg.org/multipage/browsing-the-web.html#populating-a-session-history-entry)

​				[7.4.6 应用历史脚印](https://html.spec.whatwg.org/multipage/browsing-the-web.html#applying-the-history-step)

​						[7.4.6.1 更新 `traversable`](https://html.spec.whatwg.org/multipage/browsing-the-web.html#updating-the-traversable)
...
​						[7.4.6.4 持久化历史条目状态](https://html.spec.whatwg.org/multipage/browsing-the-web.html#persisted-user-state-restoration)

##### 		[7.5 文档生命周期](https://html.spec.whatwg.org/multipage/document-lifecycle.html#document-lifecycle)

​				[7.5.1 共享文档创建基础](https://html.spec.whatwg.org/multipage/document-lifecycle.html#shared-document-creation-infrastructure)
...
​				[7.5.4 加载 `text` 文档](https://html.spec.whatwg.org/multipage/document-lifecycle.html#read-text)

​				[7.5.5 加载 `multipart/x-mixed-replace` 文档](https://html.spec.whatwg.org/multipage/document-lifecycle.html#read-multipart-x-mixed-replace)

​				[7.5.6 加载 `media` 文档](https://html.spec.whatwg.org/multipage/document-lifecycle.html#read-media)

​				[7.5.7 加载内联内容没有 `DOM` 的文档](https://html.spec.whatwg.org/multipage/document-lifecycle.html#read-ua-inline)
...
##### 		[7.6 `"X-Frame-Options"` 标头](https://html.spec.whatwg.org/multipage/document-lifecycle.html#the-x-frame-options-header)

##### 		[7.7 `"Refresh"` 标头](https://html.spec.whatwg.org/multipage/document-lifecycle.html#the-refresh-header)

##### 		[7.8 浏览器用户接口注意事项](https://html.spec.whatwg.org/multipage/document-lifecycle.html#nav-traversal-ui)

#### [8  `Web` 应用程序 `APIs`](https://html.spec.whatwg.org/multipage/webappapis.html#webappapis)

##### 		[8.1 脚本编写](https://html.spec.whatwg.org/multipage/webappapis.html#scripting)

​				[8.1.1 引言](https://html.spec.whatwg.org/multipage/webappapis.html#introduction-11)

​				[8.1.2 代理和代理群集](https://html.spec.whatwg.org/multipage/webappapis.html#agents-and-agent-clusters)

​						[8.1.2.1 与 `JavaScript` 代理的形式化集成](https://html.spec.whatwg.org/multipage/webappapis.html#integration-with-the-javascript-agent-formalism)

​						[8.1.2.2 与 `JavaScript` 代理集群的形式化集成](https://html.spec.whatwg.org/multipage/webappapis.html#integration-with-the-javascript-agent-cluster-formalism)

​				[8.1.3 领域及其同行](https://html.spec.whatwg.org/multipage/webappapis.html#realms-and-their-counterparts)
...
​						[8.1.3.3 领域、设置对象和全局对象](https://html.spec.whatwg.org/multipage/webappapis.html#realms-settings-objects-global-objects)
...
​								[8.1.3.3.3 当前的](https://html.spec.whatwg.org/multipage/webappapis.html#current)

​								[8.1.3.3.4 相关的](https://html.spec.whatwg.org/multipage/webappapis.html#relevant)
...
​				[8.1.4 脚本处理模型](https://html.spec.whatwg.org/multipage/webappapis.html#scripting-processing-model)
...
​						[8.1.4.5 捕杀脚本](https://html.spec.whatwg.org/multipage/webappapis.html#killing-scripts)

​						[8.1.4.6 运行时脚本错误](https://html.spec.whatwg.org/multipage/webappapis.html#runtime-script-errors)

​						[8.1.4.7 未处理的期约拒绝](https://html.spec.whatwg.org/multipage/webappapis.html#unhandled-promise-rejections)

​						[8.1.4.8 导入地图解析结果](https://html.spec.whatwg.org/multipage/webappapis.html#import-map-parse-results)

​				[8.1.5 模块说明符解析](https://html.spec.whatwg.org/multipage/webappapis.html#module-specifier-resolution)
...
​				[8.1.6 `JavaScript` 标准主机钩子](https://html.spec.whatwg.org/multipage/webappapis.html#javascript-specification-host-hooks)
...
​						[8.1.6.2 `HostEnsureCanCompileStrings`（realm）](https://html.spec.whatwg.org/multipage/webappapis.html#hostensurecancompilestrings(realm))

​						[8.1.6.3 `HostPromiseRejectionTracker`（promise，operation）](https://html.spec.whatwg.org/multipage/webappapis.html#the-hostpromiserejectiontracker-implementation)

​						[8.1.6.4 与工作相关的主机钩子](https://html.spec.whatwg.org/multipage/webappapis.html#integration-with-javascript-jobs)
...
​								[8.1.6.4.2 `HostEnqueueFinalizationRegistryCleanupJob`（finalizationRegistry）](https://html.spec.whatwg.org/multipage/webappapis.html#hostenqueuefinalizationregistrycleanupjob)

​								[8.1.6.4.3 `HostEnqueuePromiseJob`（job， realm）](https://html.spec.whatwg.org/multipage/webappapis.html#hostenqueuepromisejob)

​								[8.1.6.4.4 `HostMakeJobCallback`（callable）](https://html.spec.whatwg.org/multipage/webappapis.html#hostmakejobcallback)

​						[8.1.6.5 与模块相关的主机钩子](https://html.spec.whatwg.org/multipage/webappapis.html#integration-with-the-javascript-module-system)
...
​				[8.1.7 事件循环](https://html.spec.whatwg.org/multipage/webappapis.html#event-loops)
...
​						[8.1.7.3 处理模型](https://html.spec.whatwg.org/multipage/webappapis.html#event-loop-processing-model)
...
​				[8.1.8 事件](https://html.spec.whatwg.org/multipage/webappapis.html#events)

​						[8.1.8.1 事件处理程序](https://html.spec.whatwg.org/multipage/webappapis.html#event-handler-attributes)

​						[8.1.8.2 元素、`Documemnt` 对象和 `Window` 对象上的事件处理程序](https://html.spec.whatwg.org/multipage/webappapis.html#event-handlers-on-elements,-document-objects,-and-window-objects)

​								[8.1.8.2.1 `IDL` 定义](https://html.spec.whatwg.org/multipage/webappapis.html#idl-definitions)

​						[8.1.8.3 事件触发](https://html.spec.whatwg.org/multipage/webappapis.html#event-firing)

##### 		[8.2 `WindowOrWorkerGlobalScope` 混合](https://html.spec.whatwg.org/multipage/webappapis.html#windoworworkerglobalscope-mixin)

##### 		[8.3 `Base64` 实用工具](https://html.spec.whatwg.org/multipage/webappapis.html#atob)

##### 		[8.4 动态标记插入](https://html.spec.whatwg.org/multipage/dynamic-markup-insertion.html#dynamic-markup-insertion)
...
##### 		[8.8 用户提示](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#user-prompts)

​				[8.8.1 简单的对话框](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#simple-dialogs)

​				[8.8.2 打印](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#printing)

##### 		[8.9 系统状态和功能](https://html.spec.whatwg.org/multipage/system-state.html#system-state-and-capabilities)

​				[8.9.1 `Navigator` 对象](https://html.spec.whatwg.org/multipage/system-state.html#the-navigator-object)

​						[8.9.1.1 客户端识别](https://html.spec.whatwg.org/multipage/system-state.html#client-identification)
...
​						[8.9.1.4 自定义方案处理程序：`registerProtocolHandler()` 方法](https://html.spec.whatwg.org/multipage/system-state.html#custom-handlers)
...
#### [9 通讯](https://html.spec.whatwg.org/multipage/comms.html#comms)

##### 		[9.1 `MessageEvent` 接口](https://html.spec.whatwg.org/multipage/comms.html#the-messageevent-interface)

##### 		[9.2 服务器发送的事件](https://html.spec.whatwg.org/multipage/server-sent-events.html#server-sent-events)

​				[9.2.1 引言](https://html.spec.whatwg.org/multipage/server-sent-events.html#server-sent-events-intro)

​				[9.2.2 `EventSource` 接口](https://html.spec.whatwg.org/multipage/server-sent-events.html#the-eventsource-interface)

​				[9.2.3 处理模型](https://html.spec.whatwg.org/multipage/server-sent-events.html#sse-processing-model)

​				[9.2.4 `"Last-Event-ID"` 标头](https://html.spec.whatwg.org/multipage/server-sent-events.html#the-last-event-id-header)
...
​				[9.2.7 编写注意事项](https://html.spec.whatwg.org/multipage/server-sent-events.html#authoring-notes)
...
##### 		[9.3 跨文档消息传递](https://html.spec.whatwg.org/multipage/web-messaging.html#web-messaging)

​				[9.3.1 引言](https://html.spec.whatwg.org/multipage/web-messaging.html#introduction-12)

​				[9.3.2 安全](https://html.spec.whatwg.org/multipage/web-messaging.html#security-postmsg)
...
##### 		[9.4 频道消息传递](https://html.spec.whatwg.org/multipage/web-messaging.html#channel-messaging)

​				[9.4.1 引言](https://html.spec.whatwg.org/multipage/web-messaging.html#introduction-13)

​						[9.4.1.1 示例](https://html.spec.whatwg.org/multipage/web-messaging.html#examples-5)

​						[9.4.1.2 端口作为 `Web` 上对象能力模型的基础](https://html.spec.whatwg.org/multipage/web-messaging.html#ports-as-the-basis-of-an-object-capability-model-on-the-web)
...
​				[9.4.4 向多个端口广播](https://html.spec.whatwg.org/multipage/web-messaging.html#broadcasting-to-many-ports)

​				[9.4.5 端口和垃圾回收](https://html.spec.whatwg.org/multipage/web-messaging.html#ports-and-garbage-collection)

##### 		[9.5 广播到其他浏览上下文](https://html.spec.whatwg.org/multipage/web-messaging.html#broadcasting-to-other-browsing-contexts)

#### [10 `Web workers`](https://html.spec.whatwg.org/multipage/workers.html#workers)

##### 		[10.1 引言](https://html.spec.whatwg.org/multipage/workers.html#introduction-14)

​				[10.1.1 范围](https://html.spec.whatwg.org/multipage/workers.html#scope-2)

​				[10.1.2 示例](https://html.spec.whatwg.org/multipage/workers.html#examples-6)

​						[10.1.2.1 后台数字处理工作者线程](https://html.spec.whatwg.org/multipage/workers.html#a-background-number-crunching-worker)

​						[10.1.2.2 使用 `JavaScript` 模块作为工作者线程](https://html.spec.whatwg.org/multipage/workers.html#module-worker-example)

​						[10.1.2.3 共享工作者线程简介](https://html.spec.whatwg.org/multipage/workers.html#shared-workers-introduction)

​						[10.1.2.4 使用共享工作者线程共享状态](https://html.spec.whatwg.org/multipage/workers.html#shared-state-using-a-shared-worker)
...
​				[10.1.3 教程](https://html.spec.whatwg.org/multipage/workers.html#tutorials)

​						[10.1.3.1 创建专用工作者线程](https://html.spec.whatwg.org/multipage/workers.html#creating-a-dedicated-worker)

​						[10.1.3.2 与专用工作者线程通讯](https://html.spec.whatwg.org/multipage/workers.html#communicating-with-a-dedicated-worker)

​						[10.1.3.3 共享工作者线程](https://html.spec.whatwg.org/multipage/workers.html#shared-workers)

##### 		[10.2 基础](https://html.spec.whatwg.org/multipage/workers.html#infrastructure-2)

​				[10.2.1 全局作用域](https://html.spec.whatwg.org/multipage/workers.html#the-global-scope)

​						[10.2.1.1 `WorkerGlobalScope` 公共接口](https://html.spec.whatwg.org/multipage/workers.html#the-workerglobalscope-common-interface)

​						[10.2.1.2 专用工作者线程和 `DedicatedWorkerGlobalScope` 接口](https://html.spec.whatwg.org/multipage/workers.html#dedicated-workers-and-the-dedicatedworkerglobalscope-interface)

​						[10.2.1.3 共享工作者线程和 `SharedWorkerGlobalScope` 接口](https://html.spec.whatwg.org/multipage/workers.html#shared-workers-and-the-sharedworkerglobalscope-interface)

​				[10.2.2 事件循环](https://html.spec.whatwg.org/multipage/workers.html#worker-event-loop)

​				[10.2.3 工作者线程的一生](https://html.spec.whatwg.org/multipage/workers.html#the-worker's-lifetime)
...
​				[10.2.6 创建工作者线程](https://html.spec.whatwg.org/multipage/workers.html#creating-workers)

​						[10.2.6.1 `AbstractWorker` 混合](https://html.spec.whatwg.org/multipage/workers.html#the-abstractworker-mixin)

​						[10.2.6.2 工作者线程的脚本设置](https://html.spec.whatwg.org/multipage/workers.html#script-settings-for-workers)

​						[10.2.6.3 专用工作者线程和 `Worker` 接口](https://html.spec.whatwg.org/multipage/workers.html#dedicated-workers-and-the-worker-interface)

​						[10.2.6.4 共享工作者线程和 `SharedWorker` 接口](https://html.spec.whatwg.org/multipage/workers.html#shared-workers-and-the-sharedworker-interface)

​				[10.2.7 并发硬件性能](https://html.spec.whatwg.org/multipage/workers.html#navigator.hardwareconcurrency)

##### 		[10.3 可供工作者线程使用的 `API`](https://html.spec.whatwg.org/multipage/workers.html#apis-available-to-workers)

​				[10.3.1 导入脚本和库](https://html.spec.whatwg.org/multipage/workers.html#importing-scripts-and-libraries)

​				[10.3.2 `WorkerNavigator` 接口](https://html.spec.whatwg.org/multipage/workers.html#the-workernavigator-object)

​				[10.3.3 `WorkerLocation` 接口](https://html.spec.whatwg.org/multipage/workers.html#worker-locations)

#### [11 `Worklets`](https://html.spec.whatwg.org/multipage/worklets.html#worklets)

##### 		[11.1 引言](https://html.spec.whatwg.org/multipage/worklets.html#worklets-intro)

​				[11.1.1 动机](https://html.spec.whatwg.org/multipage/worklets.html#worklets-motivations)

​				[11.1.2 代码幂等](https://html.spec.whatwg.org/multipage/worklets.html#worklets-idempotent)

​				[11.1.3 预测执行](https://html.spec.whatwg.org/multipage/worklets.html#worklets-speculative)

##### 		[11.2 示例](https://html.spec.whatwg.org/multipage/worklets.html#worklets-examples)

​				[11.2.1 加载脚本](https://html.spec.whatwg.org/multipage/worklets.html#worklets-examples-loading)

​				[11.2.2 注册一个类并调用其方法](https://html.spec.whatwg.org/multipage/worklets.html#worklets-example-registering)

##### 		[11.3 基础](https://html.spec.whatwg.org/multipage/worklets.html#worklets-infrastructure)

​				[11.3.1 全局作用域](https://html.spec.whatwg.org/multipage/worklets.html#worklets-global)
...
​						[11.3.1.3 `worklets` 的脚本设置](https://html.spec.whatwg.org/multipage/worklets.html#script-settings-for-worklets)

​				[11.3.2 `Worklet` 类](https://html.spec.whatwg.org/multipage/worklets.html#worklets-worklet)

​				[11.3.3 `worklet` 的一生](https://html.spec.whatwg.org/multipage/worklets.html#worklets-lifetime)

#### [12 `Web` 存储](https://html.spec.whatwg.org/multipage/webstorage.html#webstorage)

##### 		[12.1 引言](https://html.spec.whatwg.org/multipage/webstorage.html#introduction-15)

##### 		[12.2 `API`](https://html.spec.whatwg.org/multipage/webstorage.html#storage)

​				[12.2.1 `Storage` 接口](https://html.spec.whatwg.org/multipage/webstorage.html#the-storage-interface)

​				[12.2.2 `sessionStorage` 获取器](https://html.spec.whatwg.org/multipage/webstorage.html#the-sessionstorage-attribute)

​				[12.2.3 `localStorage` 获取器](https://html.spec.whatwg.org/multipage/webstorage.html#the-localstorage-attribute)

​				[12.2.4 `StorageEvent` 接口](https://html.spec.whatwg.org/multipage/webstorage.html#the-storageevent-interface)

##### 		[12.3 隐私](https://html.spec.whatwg.org/multipage/webstorage.html#privacy)
...
##### 		[12.4 安全](https://html.spec.whatwg.org/multipage/webstorage.html#security-storage)
...
#### [13 `HTML` 语法](https://html.spec.whatwg.org/multipage/syntax.html#syntax)

##### 		[13.1 编写 `HTML` 文档](https://html.spec.whatwg.org/multipage/syntax.html#writing)

​				[13.1.1 文档类型](https://html.spec.whatwg.org/multipage/syntax.html#the-doctype)

​				[13.1.2 元素](https://html.spec.whatwg.org/multipage/syntax.html#elements-2)

​						[13.1.2.1 开始标签](https://html.spec.whatwg.org/multipage/syntax.html#start-tags)

​						[13.1.2.2 结束标签](https://html.spec.whatwg.org/multipage/syntax.html#end-tags)
...
​						[13.1.2.6 对原始文本和可逃避的原始文本元素内容的限制](https://html.spec.whatwg.org/multipage/syntax.html#cdata-rcdata-restrictions)

​				[13.1.3 文本](https://html.spec.whatwg.org/multipage/syntax.html#text-2)

​						[13.1.3.1 换行](https://html.spec.whatwg.org/multipage/syntax.html#newlines)
...
##### 		[13.2 解析 `HTML` 文档](https://html.spec.whatwg.org/multipage/parsing.html#parsing)
...
​				[13.2.3 输入字节流](https://html.spec.whatwg.org/multipage/parsing.html#the-input-byte-stream)

​						[13.2.3.1 使用已知的字符编码进行解析](https://html.spec.whatwg.org/multipage/parsing.html#parsing-with-a-known-character-encoding)
...
​				[13.2.4 解析状态](https://html.spec.whatwg.org/multipage/parsing.html#parse-state)
...
​						[13.2.4.3 活跃的格式化元素列表](https://html.spec.whatwg.org/multipage/parsing.html#the-list-of-active-formatting-elements)

​						[13.2.4.4 元素指针](https://html.spec.whatwg.org/multipage/parsing.html#the-element-pointers)

​						[13.2.4.5 其他的解析状态标志](https://html.spec.whatwg.org/multipage/parsing.html#other-parsing-state-flags)

​				[13.2.5 标记化](https://html.spec.whatwg.org/multipage/parsing.html#tokenization)
...
​						[13.2.5.3 原始文本（`RAWTEXT`）状态](https://html.spec.whatwg.org/multipage/parsing.html#rawtext-state)

​						[13.2.5.4 脚本数据状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-state)

​						[13.2.5.5 明文（`PLAINTEXT`）状态](https://html.spec.whatwg.org/multipage/parsing.html#plaintext-state)
...
​						[13.2.5.10 `RCDATA` 结束标签打开状态](https://html.spec.whatwg.org/multipage/parsing.html#rcdata-end-tag-open-state)

​						[13.2.5.11 `RCDATA` 结束标签名称状态](https://html.spec.whatwg.org/multipage/parsing.html#rcdata-end-tag-name-state)

​						[13.2.5.12 `RAWTEXT` 小于符号状态](https://html.spec.whatwg.org/multipage/parsing.html#rawtext-less-than-sign-state)

​						[13.2.5.13 `RAWTEXT` 结束标签打开状态](https://html.spec.whatwg.org/multipage/parsing.html#rawtext-end-tag-open-state)

​						[13.2.5.14 `RAWTEXT` 结束标签名称状态](https://html.spec.whatwg.org/multipage/parsing.html#rawtext-end-tag-name-state)

​						[13.2.5.15 脚本数据小于符号状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-less-than-sign-state)

​						[13.2.5.16 脚本数据结束标签打开状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-end-tag-open-state)

​						[13.2.5.17 脚本数据结束标签名称状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-end-tag-name-state)

​						[13.2.5.18 脚本数据转义启动状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-escape-start-state)

​						[13.2.5.19 脚本数据转义启动 `dash` 状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-escape-start-dash-state)

​						[13.2.5.20 脚本数据转义状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-escaped-state)

​						[13.2.5.21 脚本数据转义 `dash` 状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-escaped-dash-state)

​						[13.2.5.22 脚本数据转义 `dash dash` 状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-escaped-dash-dash-state)

​						[13.2.5.23 脚本数据转义小于符号状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-escaped-less-than-sign-state)

​						[13.2.5.24 脚本数据转义结束标签打开状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-escaped-end-tag-open-state)

​						[13.2.5.25 脚本数据转义结束标签名称状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-escaped-end-tag-name-state)
...
​						[13.2.5.28 脚本数据双重转义 `dash` 状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-double-escaped-dash-state)

​						[13.2.5.29 脚本数据双重转义 `dash dash` 状态](https://html.spec.whatwg.org/multipage/parsing.html#script-data-double-escaped-dash-dash-state)
...
​						[13.2.5.38 属性值（无引号）状态](https://html.spec.whatwg.org/multipage/parsing.html#attribute-value-(unquoted)-state)

​						[13.2.5.39 属性值（引号）状态后](https://html.spec.whatwg.org/multipage/parsing.html#after-attribute-value-(quoted)-state)

​						[13.2.5.40 自关闭开始标签状态](https://html.spec.whatwg.org/multipage/parsing.html#self-closing-start-tag-state)

​						[13.2.5.41 伪造的注释状态](https://html.spec.whatwg.org/multipage/parsing.html#bogus-comment-state)

​						[13.2.5.42 标签声明打开状态](https://html.spec.whatwg.org/multipage/parsing.html#markup-declaration-open-state)

​						[13.2.5.43 注释开始状态](https://html.spec.whatwg.org/multipage/parsing.html#comment-start-state)

​						[13.2.5.44 注释开始 `dash` 状态](https://html.spec.whatwg.org/multipage/parsing.html#comment-start-dash-state)
...
​						[13.2.5.47 注释小于符号 `bang` 状态](https://html.spec.whatwg.org/multipage/parsing.html#comment-less-than-sign-bang-state)

​						[13.2.5.48 注释小于符号 `bang dash` 状态](https://html.spec.whatwg.org/multipage/parsing.html#comment-less-than-sign-bang-dash-state)

​						[13.2.5.49 注释 小于符号 `bang dash dash` 状态](https://html.spec.whatwg.org/multipage/parsing.html#comment-less-than-sign-bang-dash-dash-state)

​						[13.2.5.50 注释结束 `dash` 状态](https://html.spec.whatwg.org/multipage/parsing.html#comment-end-dash-state)

​						[13.2.5.51 注释结束状态](https://html.spec.whatwg.org/multipage/parsing.html#comment-end-state)

​						[13.2.5.52 注释结束 `bang` 状态](https://html.spec.whatwg.org/multipage/parsing.html#comment-end-bang-state)

​						[13.2.5.53 `DOCTYPE` 状态](https://html.spec.whatwg.org/multipage/parsing.html#doctype-state)

​						[13.2.5.54 在 `DOCTYPE` 名称状态之前](https://html.spec.whatwg.org/multipage/parsing.html#before-doctype-name-state)

​						[13.2.5.55 `DOCTYPE` 名称状态](https://html.spec.whatwg.org/multipage/parsing.html#doctype-name-state)

​						[13.2.5.56 在 `DOCTYPE` 名称状态之后](https://html.spec.whatwg.org/multipage/parsing.html#after-doctype-name-state)
...
​						[13.2.5.68 伪造的 `DOCTYPE` 状态](https://html.spec.whatwg.org/multipage/parsing.html#bogus-doctype-state)

​						[13.2.5.69 `CDATA` 部分状态](https://html.spec.whatwg.org/multipage/parsing.html#cdata-section-state)

​						[13.2.5.70 `CDATA` 部分 `bracket` 状态](https://html.spec.whatwg.org/multipage/parsing.html#cdata-section-bracket-state)
...
​						[13.2.5.74 不明确的 `&` 符号状态](https://html.spec.whatwg.org/multipage/parsing.html#ambiguous-ampersand-state)
...
​				[13.2.6 树构造](https://html.spec.whatwg.org/multipage/parsing.html#tree-construction)
...
​						[13.2.6.3 关闭具有隐式结束标签的元素](https://html.spec.whatwg.org/multipage/parsing.html#closing-elements-that-have-implied-end-tags)

​						[13.2.6.4 解析 `HTML` 内容中的令牌的规则](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-inhtml)

​								[13.2.6.4.1 `"initial"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#the-initial-insertion-mode)

​								[13.2.6.4.2 `"before html"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#the-before-html-insertion-mode)

​								[13.2.6.4.3 `"before head"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#the-before-head-insertion-mode)

​								[13.2.6.4.4 `"in head"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-inhead)

​								[13.2.6.4.5 `"in head noscript"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-inheadnoscript)

​								[13.2.6.4.6 `"after head"` 插入方式](https://html.spec.whatwg.org/multipage/parsing.html#the-after-head-insertion-mode)

​								[13.2.6.4.7 `"in body"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-inbody)

​								[13.2.6.4.8 `"text"` 插入方式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-incdata)

​								[13.2.6.4.9 `"in table"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-intable)

​								[13.2.6.4.10 `"in table text"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-intabletext)

​								[13.2.6.4.11 `"in caption"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-incaption)

​								[13.2.6.4.12 `"in column group"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-incolgroup)

​								[13.2.6.4.13 `"in table body"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-intbody)

​								[13.2.6.4.14 `"in row"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-intr)

​								[13.2.6.4.15 `"in cell"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-intd)

​								[13.2.6.4.16 `"in select"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-inselect)

​								[13.2.6.4.17 `"in select in table"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-inselectintable)

​								[13.2.6.4.18 `"in template"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-intemplate)

​								[13.2.6.4.19 `"after body"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-afterbody)

​								[13.2.6.4.20 `"in frameset"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-inframeset)

​								[13.2.6.4.21 `"after frameset"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#parsing-main-afterframeset)

​								[13.2.6.4.22 `"after after body"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#the-after-after-body-insertion-mode)

​								[13.2.6.4.23 `"after after frameset"` 插入模式](https://html.spec.whatwg.org/multipage/parsing.html#the-after-after-frameset-insertion-mode)
...
​				[13.2.9 将 `HTML DOM` 强制转换为一个信息集](https://html.spec.whatwg.org/multipage/parsing.html#coercing-an-html-dom-into-an-infoset)

​				[13.2.10 解析器中的错误处理和奇怪情况介绍](https://html.spec.whatwg.org/multipage/parsing.html#an-introduction-to-error-handling-and-strange-cases-in-the-parser)

​						[13.2.10.1 嵌套错误的标签：`<b><i></b></i>`](https://html.spec.whatwg.org/multipage/parsing.html#misnested-tags:-b-i-/b-/i)

​						[13.2.10.2 嵌套错误的标签：`<b><p></b></p>`](https://html.spec.whatwg.org/multipage/parsing.html#misnested-tags:-b-p-/b-/p)

​						[13.2.10.3 表格中的意外标签](https://html.spec.whatwg.org/multipage/parsing.html#unexpected-markup-in-tables)
...
​						[13.2.10.6 未关闭的格式化元素](https://html.spec.whatwg.org/multipage/parsing.html#unclosed-formatting-elements)
...
#### [14 `XML` 语法](https://html.spec.whatwg.org/multipage/xhtml.html#the-xhtml-syntax)

##### 		[14.1 用 `XML` 语法编写文档](https://html.spec.whatwg.org/multipage/xhtml.html#writing-xhtml-documents)
...
#### [15 渲染](https://html.spec.whatwg.org/multipage/rendering.html#rendering)

##### 		[15.1 引言](https://html.spec.whatwg.org/multipage/rendering.html#introduction-16)

##### 		[15.2 `CSS` 用户代理样式表和表现提示](https://html.spec.whatwg.org/multipage/rendering.html#the-css-user-agent-style-sheet-and-presentational-hints)

##### 		[15.3 非可替换元素](https://html.spec.whatwg.org/multipage/rendering.html#non-replaced-elements)
...
​				[15.3.3 流动内容](https://html.spec.whatwg.org/multipage/rendering.html#flow-content-3)

​				[15.3.4 句式内容](https://html.spec.whatwg.org/multipage/rendering.html#phrasing-content-3)
...
​				[15.3.8 表格](https://html.spec.whatwg.org/multipage/rendering.html#tables-2)

​				[15.3.9 外边距塌陷怪象](https://html.spec.whatwg.org/multipage/rendering.html#margin-collapsing-quirks)

​				[15.3.10 表单控件](https://html.spec.whatwg.org/multipage/rendering.html#form-controls)

​				[15.3.11 `hr` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-hr-element-2)

​				[15.3.12 `fieldset` 和 `legend` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-fieldset-and-legend-elements)

##### 		[15.4 可替换元素](https://html.spec.whatwg.org/multipage/rendering.html#replaced-elements)

​				[15.4.1 嵌入式内容](https://html.spec.whatwg.org/multipage/rendering.html#embedded-content-rendering-rules)

​				[15.4.2 图像](https://html.spec.whatwg.org/multipage/rendering.html#images-3)

​				[15.4.3 嵌入式内容和图像的属性](https://html.spec.whatwg.org/multipage/rendering.html#attributes-for-embedded-content-and-images)

​				[15.4.4 图像地图](https://html.spec.whatwg.org/multipage/rendering.html#image-maps-2)

##### 		[15.5 小部件](https://html.spec.whatwg.org/multipage/rendering.html#widgets)
...
​				[15.5.3 `button` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-button-element-2)

​				[15.5.4 `details` 和 `summary` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-details-and-summary-elements)

​				[15.5.5 作为文本输入小部件的 `input` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-input-element-as-a-text-entry-widget)

​				[15.5.6 作为特定域的小部件的 `input` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-input-element-as-domain-specific-widgets)

​				[15.5.7 作为范围控制部件的 `input` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-input-element-as-a-range-control)

​				[15.5.8 作为颜色源泉的 `input` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-input-element-as-a-colour-well)

​				[15.5.9 作为复选框和单选按钮小部件的 `input` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-input-element-as-a-checkbox-and-radio-button-widgets)

​				[15.5.10 作为文件上传控件的 `input` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-input-element-as-a-file-upload-control)

​				[15.5.11 作为按钮的 `input` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-input-element-as-a-button)

​				[15.5.12 `marquee` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-marquee-element-2)

​				[15.5.13 `meter` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-meter-element-2)

​				[15.5.14 `progress` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-progress-element-2)

​				[15.5.15 `select` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-select-element-2)

​				[15.5.16 `textarea` 元素](https://html.spec.whatwg.org/multipage/rendering.html#the-textarea-element-2)

##### 		[15.6 框架和框架集](https://html.spec.whatwg.org/multipage/rendering.html#frames-and-framesets)

##### 		[15.7 互动媒体](https://html.spec.whatwg.org/multipage/rendering.html#interactive-media)

​				[15.7.1 链接、表单和导航](https://html.spec.whatwg.org/multipage/rendering.html#links,-forms,-and-navigation)

​				[15.7.2 `title` 属性](https://html.spec.whatwg.org/multipage/rendering.html#the-title-attribute-2)
...
#### [16 过时的功能](https://html.spec.whatwg.org/multipage/obsolete.html#obsolete)

##### 		[16.1 过时但符合标准的功能](https://html.spec.whatwg.org/multipage/obsolete.html#obsolete-but-conforming-features)

​				[16.1.1 对过时但符合标准的功能的警告](https://html.spec.whatwg.org/multipage/obsolete.html#warnings-for-obsolete-but-conforming-features)

##### 		[16.2 不符合标准的功能](https://html.spec.whatwg.org/multipage/obsolete.html#non-conforming-features)

##### 		[16.3 实现需求](https://html.spec.whatwg.org/multipage/obsolete.html#requirements-for-implementations)

​				[16.3.1 `marquee` 元素](https://html.spec.whatwg.org/multipage/obsolete.html#the-marquee-element)

​				[16.3.2 框架](https://html.spec.whatwg.org/multipage/obsolete.html#frames)

​				[16.3.3 其他的元素、属性和 `API`](https://html.spec.whatwg.org/multipage/obsolete.html#other-elements,-attributes-and-apis)

#### [17 `IANA` 注意事项](https://html.spec.whatwg.org/multipage/iana.html#iana)
...
##### 		[17.6 `text/event-stream`](https://html.spec.whatwg.org/multipage/iana.html#text/event-stream)

##### 		[17.7 `web+` 方案前缀](https://html.spec.whatwg.org/multipage/iana.html#web+-scheme-prefix)



#### [索引](https://html.spec.whatwg.org/multipage/indices.html#index)
